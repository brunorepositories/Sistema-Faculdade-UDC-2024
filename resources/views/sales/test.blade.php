                        ...
                        <div class="col-lg-8 mx-auto">
                            ...
                            <div class="row g-6">
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="position-relative"><select id="state"
                                            class="select2 form-select select2-hidden-accessible" data-allow-clear="true"
                                            data-select2-id="state" tabindex="-1" aria-hidden="true">
                                            ...
                                            dir="ltr" data-select2-id="1" style="width: 430.328px;"><span
                                                class="selection"><span
                                                    class="select2-selection select2-selection--single" role="combobox"
                                                    aria-haspopup="true" aria-expanded="false" tabindex="0"
                                                    aria-disabled="false" aria-labelledby="select2-state-container"><span
                                ...
                                <div class="col-12">
                                    <ul class="list-group">
                                        <li class="list-group-item d-flex justify-content-between flex-column flex-sm-row">
                                            ...
                                            <div class="apply mt-4 mt-sm-0"><button
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="collapsible-payment-cash">
                                            Cash On Delivery
                                            <i class="bx bx-help-circle" data-bs-toggle="tooltip" data-bs-placement="top"
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <span class="input-group-text cursor-pointer"
                                                            id="collapsible-payment-cvv2"><i class="bx bx-help-circle"
