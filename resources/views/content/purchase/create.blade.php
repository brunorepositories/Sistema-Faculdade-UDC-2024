...
@section('content')
    <div class="card mb-10">
        <h4 class="card-header">Cadastro de Nota de Compra</h4>
        ...
        <div class="card-body">
            ...
            <form id="purchaseForm" method="POST" action="{{ route('purchase.store') }}">
                ...
                <div id="step1" class="step">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">Etapa 1: Informações Básicas</h5>
                        </div>
                ...
                <div id="step2" class="step">
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">Etapa 2: Adicionar Produtos e Condições de Pagamento</h5>
                        </div>
                ...
                <div id="step3" class="step">
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">Etapa 3: Gerar Parcelas</h5>
                        </div>
